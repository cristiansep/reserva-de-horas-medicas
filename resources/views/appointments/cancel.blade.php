        ...
        <div class="card-body">
          ...
          @if($role == 'patient')
              <p>
                  ...
                  para el dia {{$appointment->schedule_date_new}}
              </p>
          @elseif($role == 'doctor')
              <p>
                ...
                (especialidad) {{$appointment->specialty->name}}
                para el dia {{$appointment->schedule_date_new}}
                (hora {{$appointment->schedule_time_new}}):
              </p>
          @else
              <p>
                ...
                (especialidad) {{$appointment->specialty->name}}
                el dia {{$appointment->schedule_date_new}}
                (hora {{$appointment->schedule_time_new}}):
              </p>
          @endif
          ...
          <form action="{{ url('/appointments/'.$appointment->id. '/cancel') }}" method="POST">
            ...
            <div class="form-group">
                <label for="justification">Por favor cuéntenos el motivo de su cancelación:</label>
