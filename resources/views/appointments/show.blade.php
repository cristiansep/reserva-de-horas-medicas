...
@section('content')
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <ul>
                <li>
                    <strong>Fecha:</strong> {{$appointment->schedule_date_new}}
                </li>
                <li>
                    <strong>Hora:</strong> {{$appointment->schedule_time_new}}
                </li>
            ...
            <div class="alert alert-warning">
                ...
                <ul> 
                    @if($appointment->cancellation)
                        ...
                        <li>
                            <strong>¿Qien canceló la cita?:</strong> 
                        ...
                        <li>
                            <strong>Justificación:</strong> {{$appointment->cancellation->justification}}
                        </li>
                    @else
